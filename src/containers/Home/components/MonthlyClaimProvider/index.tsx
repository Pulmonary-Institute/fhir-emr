...
import PieChartForTopEncounters from './pieChartForTopEncounters';
    ...
    return (
        <>
            <div className="monthlyClaims">
                <div className="table-monthly-claims-p">
                    <TableContainer
                        component={Paper}
                                    ...
                                    <TableCell sx={styleRows}>
                                        ...
                                        >
                                            <div
                                                ...
                                                style={{
                                                    width: monthlyClaims[0]?.progress,
                                    ...
                                    <TableCell sx={styleRows}>
                                        ...
                                        >
                                            <div
                                                className="progress-bar"
                                                style={{
                                                    width: monthlyClaims[1]?.progress,
                                                    backgroundColor: '#4318FF',
                                                }}
                                            ></div>
                                        </div>
                                    ...
                                    <TableCell sx={styleRows}>
                                        ...
                                        >
                                            <div
                                                className="progress-bar"
                                                style={{
                                                    width: monthlyClaims[2]?.progress,
                                                    backgroundColor: '#4318FF',
                                                }}
                                            ></div>
                                        </div>
                                    ...
                                    <TableCell sx={styleRows}>
                                        ...
                                        >
                                            <div
                                                className="progress-bar"
                                                style={{
                                                    width: monthlyClaims[3]?.progress,
                                                    backgroundColor: '#4318FF',
                                                }}
                                            ></div>
                                        </div>
                                    ...
                                    <TableCell sx={styleRows}>
                                        ...
                                        >
                                            <div
                                                className="progress-bar"
                                                style={{
                                                    width: monthlyClaims[4]?.progress,
                                                    backgroundColor: '#4318FF',
                                                }}
                                            ></div>
                                        </div>
